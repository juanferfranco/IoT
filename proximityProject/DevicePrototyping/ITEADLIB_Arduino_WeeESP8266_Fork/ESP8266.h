...
/*
Si no define ESP8266_RFDUINO
debe definir si la UART será por software o hardware
*/

#define ESP8266_RFDUINO
...
#ifdef ESP8266_RFDUINO
    ESP8266(UARTClass &uart);
    void initUart(uint32_t baud = 9600);
#else    
    #ifdef ESP8266_USE_SOFTWARE_SERIAL
        /*
         * Constuctor. 
